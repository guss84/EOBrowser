...
class Tutorial extends Component {
  ...
  resetClosingTutorialAnimation() {
    document.getElementById('animatedInfoPanelButton').classList.remove('activateCloseAnimation');
  }
  executeClosingTutorialAnimation() {
    document.getElementById('animatedInfoPanelButton').classList.add('activateCloseAnimation');
  }
  ...
  render() {
    return (
      <div>
        <div id="animatedInfoPanelButton" className="panelButton floatItem" title="Show info">
        ...
        <div
          id="infoButton"
          className="infoPanelButton panelButton floatItem"
          title="Show info"
          onClick={ev => {
