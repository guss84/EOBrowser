    ...
    content: (
      <div className="contentDivStyle">
        ...
        <ul>
          ...
          <li>
            Set different parameters such as <b>atmospheric correction</b>, <b>contrast</b> (gain) and{' '}
            <b>luminance</b> (gamma) by clicking sliders icon <i className="fa fa-sliders" />.
          </li>
        </ul>
      </div>
    ),
  ...
  },
  {
    ...
    content: (
      <div className="contentDivStyle">
        ...
        <br />
        You can change the order of the pins by dragging them up or down the list.
        <br />
        You can compare pinned items by clicking Compare button{' '}
        <a>
